...
- [x] 7.0 Spikes — de-risk ก่อน commit ทำ port เต็ม (ทุกข้อต้องผ่านก่อนไป 7.1)
...
- [x] 7.1 Elysia app skeleton + middleware → plugins (`apps/api/src/plugins/`)
...
- [x] 7.2 Rewrite routes/controllers ทีละไฟล์ (เล็กก่อน) — **ยังไม่ใส่ pagination**
...
- [x] 7.3 Test runner Jest → `bun test` (**Checkpoint A**)
...
- [x] 7.5 Pagination — backend (**Checkpoint B**)
